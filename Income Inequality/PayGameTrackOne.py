...
def turtle():
    ...
    for i in range(num_agents):
        ...
        # Track income of the first person
        if i == 0:
            P0_track[epoch] = s_self
...
if __name__ == '__main__':
    setup()
    print("Started... ")
    util.plot(num_levels,num_classes, count_levels_list,count_levels_combined)#initial
